...
questions <- c(NA, NA, NA, NA, NA, NA, "Which of these best describes you?", 
               ...
               "Please indicate if the following is a reason or not a reason why you are not currently looking for a relationship or dates: Just like being single", 
               "Please indicate if the following is a reason or not a reason why you are not currently looking for a relationship or dates: Have more important priorities right now", 
               "Please indicate if the following is a reason or not a reason why you are not currently looking for a relationship or dates: Feel like I am too old to date",
               "Please indicate if the following is a reason or not a reason why you are not currently looking for a relationship or dates: Have health problems that make it difficult to date", 
               "Please indicate if the following is a reason or not a reason why you are not currently looking for a relationship or dates: Haven't had luck with dating or relationships in the past",  
               "Please indicate if the following is a reason or not a reason why you are not currently looking for a relationship or dates: Too busy", 
               "Please indicate if the following is a reason or not a reason why you are not currently looking for a relationship or dates: Feel like no one would be interested in dating me", 
               "Please indicate if the following is a reason or not a reason why you are not currently looking for a relationship or dates: Not ready to date after ending a relationship",
               ...
               "Why do you think dating is harder today than it was 10 years ago?", 
               #THIS IS WHERE I TOOK A BREAK (LA)
               NA, "Why do you think dating is easier today than it was 10 years ago for most people?", 
